...
ggplot(byear,aes(x=Year))+
  ...
  labs(title="Mean Average/Total Sales by birthyear", x= "Birthyear(19XX)")
    scale_y_continuous(name="Average/Total sales", labels = comma)
...
plot.roc(ifelse(df_test$target_customer=="is_target",1,0),ifelse(rf.pred=="is_target",1,0),percent=T,main="ROC, Random Forest Model")
print(auc(ifelse(df_test$target_customer=="is_target",1,0),ifelse(rf.pred=="is_target",1,0),percent=T,main="ROC, Random Forest Model"))

```
```{r}

plot.roc(ifelse(df_test$target_customer=="is_target",1,0),ifelse(xgb.pred=="is_target",1,0),percent=T,main="ROC, XgBoost Model")
print(auc(ifelse(df_test$target_customer=="is_target",1,0),ifelse(xgb.pred=="is_target",1,0),percent=T,main="ROC, XgBoost Model"))
